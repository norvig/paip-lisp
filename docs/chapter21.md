...
The predicate modifiers takes eight arguments, so it can be tricky to understand 
...
Testing could be done with run-examples, but it is convenient to provide another 
