...
  [ ](#){:#l0075}`> (setf x '((1st element) 2 (element 3) ((4)) 5))`
!!!(p) {:.unnumlist}
...
  [ ](#){:#l0150}`> (first-name '(Madam Major General Paula Jones)) ⇒`
!!!(p) {:.unnumlist}
