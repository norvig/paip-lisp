...
within Lisp. This flexibihty derives from two key features of Lisp: First, Lisp 
...
manipulates continuations and supports cal 1 /cc. Chapter 23 presents a Scheme 
compiler. 
...
AI programs. 
* .7in Practice: Examples in Pop-11 by Allan Ramsey and Rosalind Barrett. Advanced, 
